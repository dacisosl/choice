...
/**
 * 기본 평가기준 (학교 선정 계획안의 서식1 예시 + 계획안 방침의 재정 항목, 5항목 × 20점).
 * 재정 항목은 계획안이 '필수 평가요소'로 두고 있어 지울 수 없게 잠근다.
 */
export const DEFAULT_CRITERIA: Omit<Criterion, 'id' | 'subjectId'>[] = [
  ...
  { area: '교수학습 활동', text: '학습 주제에 적절하며, 실현 가능한 학습활동 및 방법을 제시하고 있는가?', points: 20, locked: false, order: 3 },
  { area: '학습평가', text: '학생 스스로 점검할 수 있는 평가 방법을 안내하고 있는가?', points: 20, locked: false, order: 4 },
  { area: '재정적 부분', text: '동일 교과목 교과용도서를 비교해 보았을 때 가격은 적정한가?', points: 20, locked: true, order: 5 },
]
