...
const EXTRAS: { icon: string; title: string; body: string }[] = [
  ...
  { icon: '📝', title: '한글(hwpx)로도 저장', body: '교육청 원본 서식 파일에 값만 채워 내려받습니다. 한글에서 열어 바로 고칠 수 있습니다.' },
...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    points: [
      ...
      '[한글(hwpx) 저장]을 누르면 교육청 원본 서식에 값을 채운 한글 파일로 받습니다.',
  ...
  },
  {
    ...
    points: ['숫자 칸은 눌러서 고칠 수 있습니다(총배점을 넘지 않게 막아 줍니다).', '[인쇄 · PDF 저장] 한 번으로 평가총괄표와 추천 의견서를 각각 저장합니다.'],
