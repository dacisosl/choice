  ...
  return (
    <div className="guide" style={{ maxWidth: 820, margin: '0 auto' }}>
      <div className="card">
        ...
        <h3>4. 운영자가 볼 수 있는 것</h3>
        <p>
          서비스 운영자(최종 관리자)는 숨은 관리 화면에서 <b>학교 아이디·학교 이름·담당자 이메일·등록일</b>만 보고, 필요하면 학교 등록을 지울 수 있습니다.
          각 학교가 등록한 과목·출판사 내용은 그 화면에 나오지 않으며, 전체 목록 조회도 접근 규칙으로 막혀 있습니다.
        </p>
